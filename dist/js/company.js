...
function companyDropdownAll() {
  var allBtnDropdown = document.querySelectorAll(".company-contacts__dropdown-button");
  allBtnDropdown.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      var menu = btn.firstElementChild.nextElementSibling.nextElementSibling;
      ...
      var textBtn = btn.firstElementChild;

      _toConsumableArray(menuItems).forEach(function (item) {
